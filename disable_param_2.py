...
for ignore_gen in range(0, 4):
    for ignore_gen2 in range(ignore_gen + 1, 4):
        # if ignore_gen == ignore_gen2:
        #     continue
        ignore_mutation_gens = [ignore_gen, ignore_gen2]
        history_col_mutants = []
        history_obj_func = []
        history_epochs = []
        ...
        x_ignore_stat.append(f'{ignore_gen}_{ignore_gen2}')
